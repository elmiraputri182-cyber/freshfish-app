...
class DataAgenPage extends StatefulWidget {
  const DataAgenPage({super.key});

  @override
  State<DataAgenPage> createState() => _DataAgenPageState();
}

class _DataAgenPageState extends State<DataAgenPage> {
  List dataAgen = [];
  List filterAgen = [];
  bool isLoading = true;
  ...
  Future<void> getDataAgen() async {
    try {
      final response = await http.get(
        Uri.parse("${Api.baseUrl}/admin/get_agen.php"),
      );
  ...
  void cariAgen() {
    ...
    setState(() {
      filterAgen = dataAgen.where((item) {
  ...
  Future<void> hapusAgen(String idUser) async {
    try {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFF0060A9), Color(0xFF00B4D8)],
                  ...
                  Expanded(
                    child: filterAgen.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemCount: filterAgen.length,
                            itemBuilder: (context, index) {
                              final item = filterAgen[index];
